    ...
    jQuery(a).each(function () {
        if (!this.grid) {
            ...
            "datatype": "local",
                ...
                d = null, 0 < i.length && (d = i[a]) && d.replace && (d = encodeURIComponent(d).replace(/[.\-%]/g, "_")), null === d && (d = a + 1), jQuery(this).jqGrid("addRowData", d, h[a]);
            for (a = 0; a < j.length; a++)
                jQuery(this).jqGrid("setSelection", j[a])
        }
    })
}
!function (b) {
    b.jgrid = b.jgrid || {}, b.extend(b.jgrid, {
            ...
            if (void 0 === e && (e = b.jgrid.formatter.date), void 0 === e.parseRe && (e.parseRe = /[Tt\\\/:_;.,\t\s-]/), e.masks.hasOwnProperty(a) && (a = e.masks[a]), c && null != c)
                if (isNaN(c - 0) || "u" !== ("" + a).toLowerCase())
                    if (c.constructor === Date)
                        ...
                        k = new Date(parseInt(i[1], 10)), i[3] && (a = 60 * Number(i[5]) + Number(i[6]), a *= "-" === i[4] ? 1 : -1, a -= k.getTimezoneOffset(), k.setTime(Number(Number(k) + 6e4 * a)));
                    else {
                        for (c = ("" + c).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe), a = a.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe), f = 0, g = a.length; g > f; f++)
                            "M" === a[f] && (i = b.inArray(c[f], e.monthNames), -1 !== i && 12 > i && (c[f] = i + 1, j.m = c[f])), "F" === a[f] && (i = b.inArray(c[f], e.monthNames, 12), -1 !== i && i > 11 && (c[f] = i + 1 - 12, j.m = c[f])), "a" === a[f] && (i = b.inArray(c[f], e.AmPm), -1 !== i && 2 > i && c[f] === e.AmPm[i] && (c[f] = i, j.h = k(c[f], j.h))), "A" === a[f] && (i = b.inArray(c[f], e.AmPm), -1 !== i && i > 1 && c[f] === e.AmPm[i] && (c[f] = i - 2, j.h = k(c[f], j.h))), "g" === a[f] && (j.h = parseInt(c[f], 10)), void 0 !== c[f] && (j[a[f].toLowerCase()] = parseInt(c[f], 10));
            ...
            if (!this.grid) {
                ...
                if ("TABLE" !== this.tagName.toUpperCase())
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)
                            ...
                            return a = parseInt(a, 10), isNaN(a) ? b || 0 : a
                                ...
                                r = function (a) {
                                    ...
                                    for (c = 0; c < d.p.colModel.length; c++)
                                        b = d.p.colModel[c], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name, d.p.keyIndex !== !1 && b.key === !0 && (d.p.keyName = e[f]), f++);
                                    return e
                                },
                                s = function (a) {
                                ...
                                u = function () {
                                    ...
                                    for (a = d.p.rownumbers === !0 ? 1 : 0, c = d.p.multiselect === !0 ? 1 : 0, e = d.p.subGrid === !0 ? 1 : 0, a = d.p.keyIndex === !1 || d.p.loadonce === !0 ? d.p.localReader.id : d.p.colModel[d.p.keyIndex + c + e + a].name, c = 0; f > c; c++)
                                        e = b.jgrid.getAccessor(d.p.data[c], a), void 0 === e && (e = "" + (c + 1)), d.p._index[e] = c
                                },
                                            ...
                                            for (d.p.grouping && (R = d.p.groupingView.groupCollapse === !0, Q = b.jgrid.getMethod("groupingPrepare")); L > M; ) {
                                                ...
                                                if (J.push(""), G && J.push(q(0, M, d.p.page, d.p.rowNum)), E && J.push(p(A, G, M, !1)), F && J.push(w.call(C, E + G, M + e)), j.repeatitems) {
                                                    ...
                                                    for (m = 0; m < H.length; m++)
                                                        u = b.jgrid.getXmlData(z, H[m]), I[d.p.colModel[m + E + F + G].name] = u, J.push(o(A, u, m + E + F + G, M + e, z, I));
                                                if (J[S] = v(A, R, B, I, z, !1), J.push("</tr>"), d.p.grouping && (N = Q.call(C, J, N, I, M), J = []), (i || d.p.treeGrid === !0) && (I._id_ = b.jgrid.stripPref(d.p.idPrefix, A), d.p.data.push(I), d.p._index[I._id_] = d.p.data.length - 1), d.p.gridview === !1 && (b("tbody:first", c).append(J.join("")), C.triggerHandler("jqGridAfterInsertRow", [A, I, z]), g && d.p.afterInsertRow.call(d, A, I, z), J = []), I = {}, D++, M++, D === O)
                                                    break
                                            }
                                        }
                                        if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? (C.jqGrid("groupingRender", N, d.p.colModel.length), N = null) : d.p.treeGrid === !0 && n > 0 ? b(d.rows[n]).after(J.join("")) : b("tbody:first", c).append(J.join(""))), d.p.subGrid === !0)
                                            try {
                                                C.jqGrid("addSubGrid", E + G)
                                            } catch (U) {
                                            }
                                        if (d.p.totaltime = new Date - h, D > 0 && 0 === d.p.records && (d.p.records = L), J = null, d.p.treeGrid === !0)
                                            try {
                                        ...
                                        if (d.p.treeGrid || d.p.scroll || (d.grid.bDiv.scrollTop = 0), d.p.reccount = D, d.p.treeANode = -1, d.p.userDataOnFooter && C.jqGrid("footerData", "set", d.p.userData, !0), i && (d.p.records = L, d.p.lastpage = Math.ceil(L / O)), f || d.updatepager(!1, !0), i)
                                            for (; L > D; ) {
                                                if (z = a[D], A = l(z, D + P), A = d.p.idPrefix + A, j.repeatitems) {
                                                    ...
                                                    for (m = 0; m < H.length; m++)
                                                        u = b.jgrid.getXmlData(z, H[m]), I[d.p.colModel[m + E + F + G].name] = u;
                                ...
                                x = function (a, c, e, f, g) {
                                    ...
                                    if (a) {
                                        ...
                                        for (d.p.grouping && (T = d.p.groupingView.groupCollapse === !0, Q = b.jgrid.getMethod("groupingPrepare")); a > m; ) {
                                            ...
                                            var U = K.length;
                                            for (K.push(""), B && K.push(q(0, m, d.p.page, d.p.rowNum)), z && K.push(p(H, B, m, M)), A && K.push(u.call(w, z + B, m + e)), D = i, c.repeatitems && (c.cell && (g = b.jgrid.getAccessor(g, c.cell) || g), b.isArray(g) && (D = C)), n = 0; n < D.length; n++)
                                                l = b.jgrid.getAccessor(g, D[n]), J[d.p.colModel[n + z + A + B].name] = l, K.push(o(H, l, n + z + A + B, m + e, g, J));
                                            if (K[U] = v(H, T, I, J, g, M), K.push("</tr>"), d.p.grouping && (S = Q.call(w, K, S, J, m), K = []), (j || d.p.treeGrid === !0) && (J._id_ = b.jgrid.stripPref(d.p.idPrefix, H), d.p.data.push(J), d.p._index[J._id_] = d.p.data.length - 1), d.p.gridview === !1 && (b("#" + b.jgrid.jqID(d.p.id) + " tbody:first").append(K.join("")), w.triggerHandler("jqGridAfterInsertRow", [H, J, g]), R && d.p.afterInsertRow.call(d, H, J, g), K = []), J = {}, x++, m++, x === N)
                                                break
                                        }
                                        if (d.p.gridview === !0 && (G = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? w.jqGrid("groupingRender", S, d.p.colModel.length) : d.p.treeGrid === !0 && G > 0 ? b(d.rows[G]).after(K.join("")) : b("#" + b.jgrid.jqID(d.p.id) + " tbody:first").append(K.join(""))), d.p.subGrid === !0)
                                            try {
                                                w.jqGrid("addSubGrid", z + B)
                                            } catch (V) {
                                            }
                                        if (d.p.totaltime = new Date - h, x > 0 && 0 === d.p.records && (d.p.records = a), d.p.treeGrid === !0)
                                            try {
                                        ...
                                        if (d.p.treeGrid || d.p.scroll || (d.grid.bDiv.scrollTop = 0), d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = a, d.p.lastpage = Math.ceil(a / N)), f || d.updatepager(!1, !0), j)
                                            for (; a > x && E[x]; ) {
                                                if (g = E[x], H = b.jgrid.getAccessor(g, F), void 0 === H && ("number" == typeof F && null != d.p.colModel[F + z + A + B] && (H = b.jgrid.getAccessor(g, d.p.colModel[F + z + A + B].name)), void 0 === H && (H = O + x, 0 === y.length && c.cell && (e = b.jgrid.getAccessor(g, c.cell) || g, H = null != e && void 0 !== e[F] ? e[F] : H))), g) {
                                                    for (H = d.p.idPrefix + H, D = i, c.repeatitems && (c.cell && (g = b.jgrid.getAccessor(g, c.cell) || g), b.isArray(g) && (D = C)), n = 0; n < D.length; n++)
                                                        J[d.p.colModel[n + z + A + B].name] = b.jgrid.getAccessor(g, D[n]);
                                ...
                                y = function () {
                                    function a(b) {
                                        ...
                                        if (null != b.rules)
                                            try {
                                                for ((e = b.rules.length && "OR" === b.groupOp.toString().toUpperCase()) && q.orBegin(), c = 0; c < b.rules.length; c++)
                                                    g = b.rules[c], f = b.groupOp.toString().toUpperCase(), p[g.op] && g.field && (h > 0 && f && "OR" === f && (q = q.or()),
                                    ...
                                    if (!d.grid.hDiv.loading) {
                                        ...
                                        if (f !== !1 && "stop" !== f)
                                            if (b.isFunction(d.p.datatype))
                                                ...
                                                if (b.isFunction(d.p.beforeRequest) && (f = d.p.beforeRequest.call(d), void 0 === f && (f = !0), f === !1))
                                                    return;
                                ...
                                D = function (a, c) {
                                    ...
                                    if (e = "pg_" + a, f = a + "_left", h = a + "_center", i = a + "_right", b("#" + b.jgrid.jqID(a)).append("<div id='" + e + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + f + "' align='left'></td><td id='" + h + "' align='center' style='white-space:pre;'></td><td id='" + i + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                                        for (m = "<td dir='" + g + "'>", m += "<select class='ui-pg-selbox' role='listbox'>", f = 0; f < d.p.rowList.length; f++)
                                            m += '<option role="option" value="' + d.p.rowList[f] + '"' + (d.p.rowNum === d.p.rowList[f] ? ' selected="selected"' : "") + ">" + d.p.rowList[f] + "</option>";
                                        m += "</select></td>"
                                    }
                                ...
                                F = function (a, c, e, f, g) {
                                    if (d.p.colModel[c].sortable && !(d.p.savedRow.length > 0)) {
                                        if (e || (d.p.lastsort === c ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[c].firstsortorder || "asc", d.p.page = 1), d.p.multiSort)
                                            E(c, g);
                                        else {
                                            if (f) {
                        ...
                        for (this.p.id = this.id, - 1 === b.inArray(d.p.multikey, ["shiftKey", "altKey", "ctrlKey"]) && (d.p.multikey = !1), d.p.keyIndex = !1, d.p.keyName = !1, f = 0; f < d.p.colModel.length; f++)
                            d.p.colModel[f] = b.extend(!0, {}, d.p.cmTemplate, d.p.colModel[f].template || {}, d.p.colModel[f]), !1 === d.p.keyIndex && !0 === d.p.colModel[f].key && (d.p.keyIndex = f);
                        ...
                        if ("horizontal" === d.p.viewsortcols[1] && (R = " ui-i-asc", T = " ui-i-desc"), K = i ? "class='ui-th-div-ie'" : "", R = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + R + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + T + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>"), d.p.multiSort)
                            for (U = d.p.sortname.split(","), f = 0; f < U.length; f++)
                                L = b.trim(U[f]).split(" "), U[f] = b.trim(L[0]), V[f] = L[1] ? b.trim(L[1]) : d.p.sortorder || "asc";
                        for (f = 0; f < this.p.colNames.length; f++)
                            L = d.p.headertitles ? ' title="' + b.jgrid.stripHtml(d.p.colNames[f]) + '"' : "", S += "<th id='" + d.p.id + "_" + d.p.colModel[f].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + g + "'" + L + ">", L = d.p.colModel[f].index || d.p.colModel[f].name, S += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[f].name + "' " + K + ">" + d.p.colNames[f], d.p.colModel[f].width = d.p.colModel[f].width ? parseInt(d.p.colModel[f].width, 10) : 150, "boolean" != typeof d.p.colModel[f].title && (d.p.colModel[f].title = !0), d.p.colModel[f].lso = "", L === d.p.sortname && (d.p.lastsort = f), d.p.multiSort && (L = b.inArray(L, U), -1 !== L && (d.p.colModel[f].lso = V[L])), S += R + "</div></th>";
                        ...
                        b(d).before(e.hDiv).click(function (a) {
                            if (P = a.target, Q = b(P, d.rows).closest("tr.jqgrow"), 0 === b(Q).length || Q[0].className.indexOf("ui-state-disabled") > -1 || (b(P, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
                                return this;
                            ...
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0)
                                if (aa = Q[0].id, ba = b.jgrid.getCellIndex(P), ca = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [aa, ba, ca, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, aa, ba, ca, a), d.p.cellEdit === !0)
                                    ...
                                    a[d.p.multikey] ? b(d).jqGrid("setSelection", aa, !0, a) : d.p.multiselect && c && (c = b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa).is(":checked"), b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + aa)[d.p.useProp ? "prop" : "attr"]("checked", c));
                                else {
        ...
        "getDataIDs": function () {
            ...
            return this.each(function () {
                if ((a = this.rows.length) && a > 0)
                    for (; a > d; )
                        b(this.rows[d]).hasClass("jqgrow") && (c[e] = this.rows[d].id, e++), d++
            }), c
        },
        ...
        "getRowData": function (a) {
            ...
            return this.each(function () {
                ...
                if (void 0 === a)
                    ...
                    if (i = b(j).jqGrid("getGridRowById", a), !i)
                        return e;
                    d = 2
                }
                for (; d > g; )
                    f && (i = j.rows[g]), b(i).hasClass("jqgrow") && (b('td[role="gridcell"]', i).each(function (a) {
        ...
        "delRowData": function (a) {
            var c, d, e = !1;
            return this.each(function () {
                if (c = b(this).jqGrid("getGridRowById", a), !c)
                    return !1;
        ...
        "setRowData": function (a, c, d) {
            ...
            return this.each(function () {
                ...
                var h, i, j = this,
                        k = typeof d,
                        l = {};
                if (i = b(this).jqGrid("getGridRowById", a), !i)
                    return !1;
                if (c)
                    try {
                        if (b(this.p.colModel).each(function (d) {
                            ...
                            if (j.p.treeGrid)
                                for (m in j.p.treeReader)
                                    j.p.treeReader.hasOwnProperty(m) && delete l[j.p.treeReader[m]];
                ...
                if (e.grid) {
                    ...
                    i && b(e).jqGrid("destroyGroupHeader", !1), b(this.p.colModel).each(function (i) {
                        if (-1 !== b.inArray(this.name, a) && this.hidden === h) {
                            if (!0 === e.p.frozenColumns && !0 === this.frozen)
                                return !0;
                ...
                b("body").is("[role]") || b("body").attr("role", "application"), a.p.scrollrows = c.scrollingRows, b(a).keydown(function (d) {
                    ...
                    if (h)
                        if (g = a.p._index[b.jgrid.stripPref(a.p.idPrefix, h.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                            ...
                            13 === d.keyCode ? (b(a).triggerHandler("jqGridKeyEnter", [a.p.selrow]), b.isFunction(c.onEnter) && c.onEnter.call(a, a.p.selrow)) : 32 === d.keyCode && (b(a).triggerHandler("jqGridKeySpace", [a.p.selrow]), b.isFunction(c.onSpace) && c.onSpace.call(a, a.p.selrow))
                })
            })
        },
        "unbindKeys": function () {
            ...
            a.fmatter = {}, a.extend(a.fmatter, {
                    ...
                    if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                        ...
                        if (c.thousandsSeparator) {
                            ...
                            var i, g = f.substring(d),
                                    j = -1;
                            for (i = d; i > 0; i--)
                                j++, 0 === j % 3 && i !== d && (!e || i > 1) && (g = h + g), g = f.charAt(i - 1) + g;
                            f = g
                        }
                ...
                if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":" : c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";" : c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":" : c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";" : c.colModel.editoptions.delimiter), f) {
                    ...
                    if (h && (i = b.split(","), i = a.map(i, function (b) {
                        ...
                        a.fmatter.isObject(f) && (h ? g = a.map(i, function (a) {
                            return f[a]
                        }) : g[0] = f[b] || "")
                }
                ...
                if (e.value) {
                    ...
                    if (e && (h = b.split(","), h = a.map(h, function (b) {
                        ...
                        (a.fmatter.isObject(g) || a.isArray(g)) && (e || (h[0] = b), d = a.map(h, function (b) {
                            var c;
                                ...
                                !n && a.isFunction(b.beforeSearch) && (n = b.beforeSearch.call(c)), n || a(c).jqGrid("setGridParam", {
                                    ...
                                    f = function (d, f, g) {
                                        ...
                                        var h, i, f = parseInt(f, 10),
                                                ...
                                                k = 0,
                                                l = a(d).attr("colname");
                                        for (h = c.p.colModel.length; h > k && c.p.colModel[k].name !== l; )
                                            k++;
                                                ...
                                                if (j.searchoptions ? (p = void 0 === j.searchoptions.value ? "" : j.searchoptions.value, q = void 0 === j.searchoptions.separator ? ":" : j.searchoptions.separator, r = void 0 === j.searchoptions.delimiter ? ";" : j.searchoptions.delimiter) : j.editoptions && (p = void 0 === j.editoptions.value ? "" : j.editoptions.value, q = void 0 === j.editoptions.separator ? ":" : j.editoptions.separator, r = void 0 === j.editoptions.delimiter ? ";" : j.editoptions.delimiter), p) {
                                                    ...
                                                    if ("string" == typeof p)
                                                        for (i = p.split(r), s = 0; s < i.length; s++)
                                                            p = i[s].split(q), r = document.createElement("option"), r.value = p[0], r.innerHTML = p[1], f.appendChild(r);
                                                    else if ("object" == typeof p)
                                                        for (s in p)
                                                            p.hasOwnProperty(s) && (r = document.createElement("option"), r.value = s, r.innerHTML = p[s], f.appendChild(r));
                    ...
                    return b = a.extend({
                        ...
                        "role": "rowheader"
                            ...
                            if (g = m[c].el, h = a(g), d = k[c], f = {
                                ...
                                for (f = b.groupHeaders[f], j = f.numberOfColumns, i = f.titleText, f = d = 0; j > f && l > c + f; f++)
                                    k[c + f].hidden || d++;
                                f = a("<th>").attr({
                                    "role": "columnheader"
                                ...
                                0 === j ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {
                                    "role": "columnheader"
                                }).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
                                    "display": d.hidden ? "none" : "",
                                    "border-top": "0px none"
                    ...
                    return this.each(function () {
                        if (this.grid) {
                            ...
                            if (!(!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable || b.p.scroll || b.p.grouping)) {
                                for (b.p.rownumbers && d++, b.p.multiselect && d++; e > d && !0 === c[d].frozen; )
                                    g = !0, f = d, d++;
                                if (f >= 0 && g) {
        ...
        function (a) {
            a.extend(a.jgrid, {
                ...
                "info_dialog": function (b, c, d, e) {
                    ...
                    if (a.fn.jqm && !g && (g = !1), b = "", 0 < f.buttons.length)
                        for (e = 0; e < f.buttons.length; e++)
                            void 0 === f.buttons[e].id && (f.buttons[e].id = "info_button_" + e), b += "<a id='" + f.buttons[e].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[e].text + "</a>";
                            ...
                            if (h = document.createElement("select"), h.setAttribute("role", "select"), e = [], !0 === c.multiple ? (b = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : b = !1, void 0 !== c.dataUrl) {
                                ...
                                if ("string" == typeof c.value)
                                    for (l = c.value.split(f), k = 0; k < l.length; k++)
                                        m = l[k].split(n), 2 < m.length && (m[1] = a.map(m, function (a, b) {
                                            return b > 0 ? a : void 0
                                    ...
                                    for (k in n = c.value)
                                        n.hasOwnProperty(k) && (f = document.createElement("option"), f.setAttribute("role", "option"), f.value = k, f.innerHTML = n[k], h.appendChild(f), b || a.trim(k) !== a.trim(d) && a.trim(n[k]) !== a.trim(d) || (f.selected = "selected"), b && (-1 < a.inArray(a.trim(n[k]), e) || -1 < a.inArray(a.trim(k), e)) && (f.selected = "selected"));
                                g(h, c, ["value"])
                            }
                            break;
                        case "text":
                        ...
                        case "custom":
                            ...
                            try {
                                if (!a.isFunction(c.custom_element))
                                    throw "e1";
                                if (!(n = c.custom_element.call(i, d, c)))
                                    throw "e2";
                ...
                "checkDate": function (a, b) {
                    var c, d = {},
                            a = a.toLowerCase();
                    if (c = -1 !== a.indexOf("/") ? "/" : -1 !== a.indexOf("-") ? "-" : -1 !== a.indexOf(".") ? "." : "/", a = a.split(c), b = b.split(c), 3 !== b.length)
                        return !1;
                    c = -1;
                    var e, f, g = -1,
                            h = -1;
                    for (f = 0; f < a.length; f++)
                        e = isNaN(b[f]) ? 0 : parseInt(b[f], 10), d[a[f]] = e,
                ...
                "checkValues": function (b, c, d, e) {
                    ...
                    if (h = this.p.colModel, void 0 === d)
                        ...
                        f = d, g = void 0 === e ? "_" : e;
                    if (f) {
                        if (g || (g = null != this.p.colNames ? this.p.colNames[c] : h[c].label), !0 === f.required && a.jgrid.isEmpty(b))
                            return [!1, g + ": " + a.jgrid.edit.msg.required, ""];
                        if (d = !1 === f.required ? !1 : !0, !0 === f.number && (!1 !== d || !a.jgrid.isEmpty(b)) && isNaN(b))
                            return [!1, g + ": " + a.jgrid.edit.msg.number, ""];
                        if (void 0 !== f.minValue && !isNaN(f.minValue) && parseFloat(b) < parseFloat(f.minValue))
                            return [!1, g + ": " + a.jgrid.edit.msg.minValue + " " + f.minValue, ""];
                        if (void 0 !== f.maxValue && !isNaN(f.maxValue) && parseFloat(b) > parseFloat(f.maxValue))
                            return [!1, g + ": " + a.jgrid.edit.msg.maxValue + " " + f.maxValue, ""];
                        if (!(!0 !== f.email || !1 === d && a.jgrid.isEmpty(b) || (e = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, e.test(b))))
                            return [!1, g + ": " + a.jgrid.edit.msg.email, ""];
                        if (!0 === f.integer && (!1 !== d || !a.jgrid.isEmpty(b)) && (isNaN(b) || 0 !== b % 1 || -1 !== b.indexOf(".")))
                            return [!1, g + ": " + a.jgrid.edit.msg.integer, ""];
                        if (!(!0 !== f.date || !1 === d && a.jgrid.isEmpty(b) || (h[c].formatoptions && h[c].formatoptions.newformat ? (h = h[c].formatoptions.newformat, a.jgrid.formatter.date.masks.hasOwnProperty(h) && (h = a.jgrid.formatter.date.masks[h])) : h = h[c].datefmt || "Y-m-d", a.jgrid.checkDate(h, b))))
                            return [!1, g + ": " + a.jgrid.edit.msg.date + " - " + h, ""];
                        if (!(!0 !== f.time || !1 === d && a.jgrid.isEmpty(b) || a.jgrid.checkTime(b)))
                            return [!1, g + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
                        if (!(!0 !== f.url || !1 === d && a.jgrid.isEmpty(b) || (e = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, e.test(b))))
                            return [!1, g + ": " + a.jgrid.edit.msg.url, ""];
                        if (!0 === f.custom && (!1 !== d || !a.jgrid.isEmpty(b)))
                            return a.isFunction(f.custom_func) ? (b = f.custom_func.call(this, b, g, c), a.isArray(b) ? b : [!1, a.jgrid.edit.msg.customarray, ""]) : [!1, a.jgrid.edit.msg.customfcheck, ""]
                    }
                    return [!0, "", ""]
                }
            })
                ...
                "searchGrid": function (b) {
                    return b = a.extend(!0, {
                        ...
                        if (d.grid) {
                            ...
                            if ("string" == typeof i && (i = a.jgrid.parse(i)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(h.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(h.themodal))[0])
                                ...
                                s = !1, b.tmplNames && b.tmplNames.length && (s = !0, r = b.tmplLabel, r += "<select class='ui-template'>", r += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                                    ...
                                    if (b.errorcheck && (f[0].hideError(), b.showQuery || f.jqFilter("toSQLString"), f[0].p.error))
                                    ...
                                    if (b.stringResult) {
                                        ...
                                        b.multipleSearch ? (i[b.sFilter] = j, a.each([b.sField, b.sValue, b.sOper], function () {
                                            i[this] = ""
                ...
                "editGridRow": function (c, d) {
                    return d = a.extend(!0, {
                                ...
                                if (b.length) {
                                    ...
                                    a.each(o.p.colModel, function () {
                                        if (this.name === c && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                            try {
                                                if (p[c] = this.editoptions.custom_value.call(o, a("#" + a.jgrid.jqID(c), v), "get"), void 0 === p[c])
                                                    throw "e1"
                                            } catch (b) {
                        ...
                        function i() {
                            ...
                            for (i in p)
                                if (p.hasOwnProperty(i) && (l = a.jgrid.checkValues.call(o, p[i], i), !1 === l[0]))
                                    break;
                            if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                                if (b[o.p.id].processing = !0, a("#sData", v + "_2").addClass("ui-state-active"), f = n.oper, e = n.id, p[f] = "_empty" === a.trim(p[o.p.id + "_id"]) ? n.addoper : n.editoper, p[f] !== n.addoper ? p[e] = p[o.p.id + "_id"] : void 0 === p[e] && (p[e] = p[o.p.id + "_id"]), delete p[o.p.id + "_id"], p = a.extend(p, b[o.p.id].editData, m), !0 === o.p.treeGrid)
                                    for (k in p[f] === n.addoper && (j = a(o).jqGrid("getGridParam", "selrow"), p["adjacency" === o.p.treeGridModel ? o.p.treeReader.parent_id_field : "parent_id"] = j), o.p.treeReader)
                                        o.p.treeReader.hasOwnProperty(k) && (m = o.p.treeReader[k], p.hasOwnProperty(m) && !(p[f] === n.addoper && "parent_id_field" === k) && delete p[m]);
                                p[e] = a.jgrid.stripPref(o.p.idPrefix, p[e]), k = a.extend({
                                    ...
                                    "complete": function (h, i) {
                                        var k;
                                        if (p[e] = o.p.idPrefix + p[e], h.status >= 300 && 304 !== h.status ? (l[0] = !1, l[1] = a(o).triggerHandler("jqGridAddEditErrorTextFormat", [h, r]), l[1] = a.isFunction(b[o.p.id].errorTextFormat) ? b[o.p.id].errorTextFormat.call(o, h, r) : i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (l = a(o).triggerHandler("jqGridAddEditAfterSubmit", [h, p, r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].afterSubmit) && (l = b[o.p.id].afterSubmit.call(o, h, p, r))), l[0] === !1)
                                            ...
                                            for (k in b[o.p.id]._savedData)
                                                b[o.p.id]._savedData.hasOwnProperty(k) && p[k] && (b[o.p.id]._savedData[k] = p[k]);
                        ...
                        if (o.grid && c) {
                            ...
                            if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                                if (B = a(o).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + a.jgrid.jqID(t)), r]), void 0 === B && (B = !0), B && z && (B = z.call(o, a("#" + t), r)), !1 === B)
                                    return;
                                ...
                                if (void 0 === B && (B = !0), B && z && (B = z.call(o, a("#" + t), r)), !1 === B)
                                    return;
                                ...
                                !0 === d.closeOnEscape && (d.closeOnEscape = !1, L = !0), u = a("<div></div>").append(F).append(u), a.jgrid.createModal(w, u, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]), z && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")), b[o.p.id].topinfo && a(".tinfo", v).show(), b[o.p.id].bottominfo && a(".binfo", v + "_2").show(), u = u = null, a("#" + a.jgrid.jqID(w.themodal)).keydown(function (c) {
                                    var e = c.target;
                                    if (a("#" + t).data("disabled") === !0)
                                        return !1;
                                    if (b[o.p.id].savekey[0] === !0 && c.which === b[o.p.id].savekey[1] && "TEXTAREA" !== e.tagName)
                                        return a("#sData", v + "_2").trigger("click"), !1;
                                    if (27 === c.which)
                                        return k() ? (L && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {
                                            "gb": d.gbox,
                                            "jqm": d.jqModal,
                                            "onClose": b[o.p.id].onClose
                                        }), !1) : !1;
                                    if (b[o.p.id].navkeys[0] === !0) {
                                        if ("_empty" === a("#id_g", v).val())
                                            return !0;
                                    ...
                                    if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                        ...
                                        var c;
                                        if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(o, "next", a("#" + t), b[1][b[0]]), void 0 !== c && c === !1))
                                            return !1;
                                    ...
                                    if (-1 !== b[0] && b[1][b[0] - 1]) {
                                        ...
                                        var c;
                                        if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(o, "prev", a("#" + t), b[1][b[0]]), void 0 !== c && c === !1))
                                            return !1;
                                        if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass("ui-state-disabled"))
                                            return !1;
                    ...
                    return d = a.extend(!0, {
                        ...
                        function f(b, c, e, f) {
                            var g, h, i, j, k, l, m, n, o, p = 0,
                                    ...
                                    w = 0;
                            for (l = 1; f >= l; l++)
                                t += 1 === l ? s : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                        ...
                        if (j.grid && c) {
                            ...
                            if (!0 === d.recreateForm && void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0] && a("#" + a.jgrid.jqID(p.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                                if (q && (r = q.call(j, a("#" + l)), void 0 === r && (r = !0)), !1 === r)
                                    return;
                                ...
                                d.gbox = "#gbox_" + a.jgrid.jqID(k), n = a("<div></div>").append(n).append("<table border='0' class='EditTable' id='" + m + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (o ? r + q : q + r) + "</td><td class='EditButton'>" + u + "</td></tr></tbody></table>"), a.jgrid.createModal(p, n, d, "#gview_" + a.jgrid.jqID(j.p.id), a("#gview_" + a.jgrid.jqID(j.p.id))[0]), o && (a("#pData, #nData", "#" + m + "_2").css("float", "right"), a(".EditButton", "#" + m + "_2").css("text-align", "left")), d.viewPagerButtons || a("#pData, #nData", "#" + m + "_2").hide(), n = null, a("#" + p.themodal).keydown(function (c) {
                                    if (27 === c.which)
                                        return b[j.p.id].closeOnEscape && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                                            "gb": d.gbox,
                                            "jqm": d.jqModal,
                                            "onClose": d.onClose
                                        }), !1;
                    ...
                    return d = a.extend(!0, {
                        ...
                        if (e.grid && c) {
                            ...
                            if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                                if (l && (o = l.call(e, a("#" + p)), void 0 === o && (o = !0)), !1 === o)
                                    return;
                                ...
                                if (d.gbox = "#gbox_" + a.jgrid.jqID(m), a.jgrid.createModal(r, q, d, "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]), l && (o = l.call(e, a("#" + p)), void 0 === o && (o = !0)), !1 === o)
                                    return;
                                a(".fm-button", "#" + p + "_2").hover(function () {
                                    ...
                                    if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                        if (b[e.p.id].processing = !0, h = e.p.prmNames, f = a.extend({}, b[e.p.id].delData, n), i = h.oper, f[i] = h.deloper, g = h.id, k = ("" + k).split(","), !k.length)
                                            return !1;
                                        for (c in k)
                                        ...
                                        f[g] = k.join(), a(this).addClass("ui-state-active"), c = a.extend({
                                            ...
                                            "complete": function (c, g) {
                                                var h;
                                                if (c.status >= 300 && 304 !== c.status ? (j[0] = !1, j[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1)
                ...
                return this.each(function () {
                    if (!this.filter) {
                        ...
                        if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                            for (b = 0; d > b; b++)
                                c = this.p.columns[b], c.stype ? c.inputtype = c.stype : c.inputtype || (c.inputtype = "text"), c.sorttype ? c.searchtype = c.sorttype : c.searchtype || (c.searchtype = "string"), void 0 === c.hidden && (c.hidden = !1), c.label || (c.label = c.name), c.index && (c.name = c.index), c.hasOwnProperty("searchoptions") || (c.searchoptions = {}), c.hasOwnProperty("searchrules") || (c.searchrules = {});
                            ...
                            this.onchange = function () {
                                ...
                                if (g.append(i), h = a("<th colspan='5' align='" + h + "'></th>"), i.append(h), !0 === this.p.ruleButtons) {
                                    ...
                                    for (d = 0; d < e.groupOps.length; d++)
                                        k = b.groupOp === f.p.groupOps[d].op ? " selected='selected'" : "", i += "<option value='" + f.p.groupOps[d].op + "'" + k + ">" + f.p.groupOps[d].text + "</option>";
                                ...
                                if (null !== c && (i = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"), h.append(i), i.bind("click", function () {
                                    ...
                                    for (d = 0; d < b.groups.length; d++)
                                        h = a("<tr></tr>"), g.append(h), i = a("<td class='first'></td>"), h.append(i), i = a("<td colspan='4'></td>"), i.append(this.createTableForGroup(b.groups[d], b)), h.append(i);
                                ...
                                function a(c) {
                                    ...
                                    if (void 0 !== c.groups)
                                        for (d = 0; d < c.groups.length; d++)
                                            1 < e.length && (e = "OR" === c.groupOp ? e + " || " : e + " && "), e += a(c.groups[d]);
                                    if (void 0 !== c.rules)
                                        for (d = 0; d < c.rules.length; d++) {
        ...
        function (a) {
            a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
                "editRow": function (b, c, d, e, f, g, h, i, j) {
                    ...
                    return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                        ...
                        h.grid && (e = a(h).jqGrid("getInd", b, !0), !1 !== e && (g = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(h, k, b) : void 0, void 0 === g && (g = !0), g && "0" === (a(e).attr("editable") || "0") && !a(e).hasClass("not-editable-row"))) && (f = h.p.colModel, a('td[role="gridcell"]', e).each(function (e) {
                            ...
                            if (27 === c.keyCode) {
                                if (a(h).jqGrid("restoreRow", b, k.afterrestorefunc), h.p._inlinenav)
                                    try {
                ...
                "saveRow": function (b, c, d, e, f, g, h) {
                    ...
                    if (!p.grid)
                        return o;
                    if (n = a(p).jqGrid("getInd", b, !0), !1 === n)
                        return o;
                        ...
                        if (i = a(n).attr("editable"), j.url = j.url || p.p.editurl, "1" === i) {
                            ...
                            if (a('td[role="gridcell"]', n).each(function (b) {
                                if (t = p.p.colModel[b], k = t.name, "cb" !== k && "subgrid" !== k && !0 === t.editable && "rn" !== k && !a(this).hasClass("not-editable-cell")) {
                                    switch (t.edittype) {
                                        ...
                                        case "select":
                                            if (t.editoptions.multiple) {
                                                ...
                                                q[k] = a("select option:selected", this).val(), r[k] = a("select option:selected", this).text();
                                        ...
                                        case "custom":
                                            try {
                                                if (!t.editoptions || !a.isFunction(t.editoptions.custom_value))
                                                    throw "e1";
                                                if (q[k] = t.editoptions.custom_value.call(p, a(".customelement", this), "get"), void 0 === q[k])
                                                    throw "e2"
                                            } catch (e) {
                                    ...
                                    if (m = a.jgrid.checkValues.call(p, q[k], b), !1 === m[0])
                                        return !1;
                            ...
                            if (i = p.p.prmNames, u = b, v = !1 === p.p.keyIndex ? i.id : p.p.colModel[p.p.keyIndex + (!0 === p.p.rownumbers ? 1 : 0) + (!0 === p.p.multiselect ? 1 : 0) + (!0 === p.p.subGrid ? 1 : 0)].name, q && (q[i.oper] = i.editoper, void 0 === q[v] || "" === q[v] ? q[v] = b : n.id !== p.p.idPrefix + q[v] && (i = a.jgrid.stripPref(p.p.idPrefix, b), void 0 !== p.p._index[i] && (p.p._index[q[v]] = p.p._index[i], delete p.p._index[i]), b = p.p.idPrefix + q[v], a(n).attr("id", b), p.p.selrow === u && (p.p.selrow = b), a.isArray(p.p.selarrrow) && (i = a.inArray(u, p.p.selarrrow), i >= 0 && (p.p.selarrrow[i] = b)), p.p.multiselect) && (i = "jqg_" + p.p.id + "_" + b, a("input.cbox", n).attr("id", i).attr("name", i)), void 0 === p.p.inlineData && (p.p.inlineData = {}), q = a.extend({}, q, p.p.inlineData, j.extraparam)), "clientArray" === j.url) {
                                ...
                                a("#lui_" + a.jgrid.jqID(p.p.id)).show(), s = a.extend({}, q, s), s[v] = a.jgrid.stripPref(p.p.idPrefix, s[v]), a.ajax(a.extend({
                                    "url": j.url,
                                    ...
                                    "complete": function (c, d) {
                                        if (a("#lui_" + a.jgrid.jqID(p.p.id)).hide(), "success" === d) {
                                            ...
                                            if (e = a(p).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, q]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(p, c)), a.isArray(e) ? (f = e[0], q = e[1] || q) : f = e, !0 === f) {
                                                ...
                                                a(p).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, null, j]), a.isFunction(j.errorfunc) && j.errorfunc.call(p, b, c, d, null), !0 === j.restoreAfterError && a(p).jqGrid("restoreRow", b, j.afterrestorefunc)
                                        }
                                    },
                                    "error": function (c, d, e) {
                                        if (a("#lui_" + a.jgrid.jqID(p.p.id)).hide(), a(p).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, e, j]), a.isFunction(j.errorfunc))
                                ...
                                switch (i.edittype) {
                                    case "select":
                                        if (i.editoptions.multiple) {
                                            ...
                                            f = a("#" + b + "_" + k + " option:selected", e.rows[b]).val(), g = a("#" + b + "_" + k + " option:selected", e.rows[b]).text();
                                        i.formatter && (g = f);
                                        break;
                                    case "checkbox":
                                        var m = ["Yes", "No"];
                                    ...
                                    case "custom":
                                        try {
                                            if (!i.editoptions || !a.isFunction(i.editoptions.custom_value))
                                                throw "e1";
                                            if (f = i.editoptions.custom_value.call(e, a(".customelement", h), "get"), void 0 === f)
                                                throw "e2";
                                            g = f
                                        } catch (n) {
                    ...
                    return this.each(function () {
                        ...
                        if (d.grid) {
                                ...
                                c = a("<td align='" + d.p.subGridModel[0].align[e] + "'></td>").html(c), a(b).append(c)
                                    ...
                                    k = function (b, c) {
                                        ...
                                        return a(h).append(i), b && (g = d.p.xmlReader.subgrid, a(g.root + " " + g.row, b).each(function () {
                                            if (i = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), !0 === g.repeatitems)
                                    ...
                                    l = function (b, c) {
                                        var e, f, g, h, i, k = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                                l = a("<tr></tr>");
                                        for (f = 0; f < d.p.subGridModel[0].name.length; f++)
                                            e = a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + d.p.direction + "'></th>"), a(e).html(d.p.subGridModel[0].name[f]), a(e).width(d.p.subGridModel[0].width[f]), a(l).append(e);
                            ...
                            for (void 0 !== c && c > 0 && (p = c, o = c + 1); o > p; )
                                a(d.rows[p]).hasClass("jqgrow") && a(d.rows[p].cells[b]).bind("click", function () {
                                    ...
                                    if (i = c.nextSibling, a(this).hasClass("sgcollapsed")) {
                                        if (f = d.p.id, e = c.id, d.p.subGridOptions.reloadOnExpand === !0 || d.p.subGridOptions.reloadOnExpand === !1 && !a(i).hasClass("ui-subgrid")) {
                                            if (g = b >= 1 ? "<td colspan='" + b + "'>&#160;</td>" : "", h = a(d).triggerHandler("jqGridSubGridBeforeExpand", [f + "_" + e, e]), (h = h === !1 || "stop" === h ? !1 : !0) && a.isFunction(d.p.subGridBeforeExpand) && (h = d.p.subGridBeforeExpand.call(d, f + "_" + e, e)), h === !1)
                                                return !1;
                                        ...
                                        if (h = a(d).triggerHandler("jqGridSubGridRowColapsed", [f + "_" + e, e]), h = h === !1 || "stop" === h ? !1 : !0, e = c.id, h && a.isFunction(d.p.subGridRowColapsed) && (h = d.p.subGridRowColapsed.call(d, f + "_" + e, e)), h === !1)
                                            return !1;
                ...
                "groupingPrepare": function (b, c, d, e) {
                    return this.each(function () {
                        var f, g, h, i, j = this.p.groupingView,
                                ...
                                m = 0;
                        for (f = 0; l > f; f++)
                            g = j.groupField[f], i = j.displayField[f], h = d[g], i = null == i ? null : d[i], null == i && (i = h), void 0 !== h && (0 === e ? (j.groups.push({
                                "idx": f,
                                "dataIndex": g,
                                "value": h,
                                "displayValue": i,
                    ...
                    return this.each(function () {
                        ...
                        if (j.hasClass(d)) {
                            if (c.showSummaryOnHide) {
                                if (i)
                                    for (; i && !(a(i).hasClass("jqfoot") && parseInt(a(i).attr("jqfootlevel"), 10) <= e); )
                                        a(i).hide(), i = i.nextSibling
                            } else if (i)
                                for (; i && (c = k(i.className), !(void 0 !== c && e >= c)); )
                                    a(i).hide(), i = i.nextSibling;
                ...
                "groupingGroupBy": function (b, c) {
                    return this.each(function () {
                        ...
                        for (e = 0; e < d.groupField.length; e++)
                            !d.groupColumnShow[e] && d.visibiltyOnNextGrouping[e] && a(this).jqGrid("showCol", d.groupField[e]);
                        for (e = 0; e < b.length; e++)
                            d.visibiltyOnNextGrouping[e] = a("#" + a.jgrid.jqID(this.p.id) + "_" + a.jgrid.jqID(b[e])).is(":visible");
                    ...
                    return this.each(function () {
                        if (void 0 === b && (b = !0), this.p.grouping = !1, !0 === b) {
                            ...
                            for (c = 0; c < d.groupField.length; c++)
                                !d.groupColumnShow[c] && d.visibiltyOnNextGrouping[c] && a(this).jqGrid("showCol", d.groupField);
            ...
            a.jgrid.extend({
                "setTreeNode": function (b, c) {
                    return this.each(function () {
                        ...
                        if (d.grid && d.p.treeGrid)
                            for (var e, f, g, h, i = d.p.expColInd, j = d.p.treeReader.expanded_field, k = d.p.treeReader.leaf_field, l = d.p.treeReader.level_field, m = d.p.treeReader.icon_field, n = d.p.treeReader.loaded; c > b; )
                        ...
                        if (e.p.treeGrid) {
                            ...
                            for (c in e.p.colModel)
                                if (e.p.colModel.hasOwnProperty(c))
                                    for (d in b = e.p.colModel[c].name, b === e.p.ExpandColumn && !g && (g = !0, e.p.expColInd = f), f++, e.p.treeReader)
                ...
                "SortTree": function (b, c, d, e) {
                    return this.each(function () {
                        if (this.grid && this.p.treeGrid) {
                            var f, g, h, i, j = [],
                                    k = this;
                            for (f = a(this).jqGrid("getRootNodes"), f = a.jgrid.from(f), f.orderBy(b, c, d, e), i = f.select(), f = 0, g = i.length; g > f; f++)
                                h = i[f], j.push(h), a(this).jqGrid("collectChildrenSortTree", j, h, b, c, d, e);
                            a.each(j, function (b) {
                ...
                "collectChildrenSortTree": function (b, c, d, e, f, g) {
                    return this.each(function () {
                        if (this.grid && this.p.treeGrid) {
                            var h, i, j, k;
                            for (h = a(this).jqGrid("getNodeChildren", c), h = a.jgrid.from(h), h.orderBy(d, e, f, g), k = h.select(), h = 0, i = k.length; i > h; h++)
                                j = k[h], b.push(j), a(this).jqGrid("collectChildrenSortTree", b, j, d, e, f, g)
                        }
                    })
                },
                    ...
                    if (d) {
                        ...
                        if (void 0 === e && (e = !1), void 0 === b || null === b) {
                            if (k = f.p.data.length - 1, k >= 0)
                                for (; k >= 0; )
                                    g = Math.max(g, parseInt(f.p.data[k][f.p.localReader.id], 10)), k--;
                            b = g + 1
                        }
                        ...
                        if (s = !1, void 0 === c || null === c || "" === c ? (t = c = null, g = "last", j = f.p.tree_root_level, k = f.p.data.length + 1) : (g = "after", h = f.p._index[c], i = f.p.data[h], c = i[f.p.localReader.id], j = parseInt(i[n], 10) + 1, k = a(f).jqGrid("getFullTreeNode", i), k.length ? (t = k = k[k.length - 1][f.p.localReader.id], k = a(f).jqGrid("getInd", t) + 1) : k = a(f).jqGrid("getInd", c) + 1, i[m] && (s = !0, i[l] = !0, a(f.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf + " tree-leaf").addClass(f.p.treeIcons.minus + " tree-minus"), f.p.data[h][m] = !1, i[r] = !0)), h = k + 1, void 0 === d[l] && (d[l] = !1), void 0 === d[r] && (d[r] = !1), d[n] = j, void 0 === d[m] && (d[m] = !0), "adjacency" === f.p.treeGridModel && (d[o] = c), "nested" === f.p.treeGridModel) {
                            ...
                            if (null !== c) {
                                if (m = parseInt(i[q], 10), n = a.jgrid.from(f.p.data), n = n.greaterOrEquals(q, m, {
                                    ...
                                    for (v in n)
                                        n.hasOwnProperty(v) && (n[v][p] = n[v][p] > m ? parseInt(n[v][p], 10) + 2 : n[v][p], n[v][q] = n[v][q] >= m ? parseInt(n[v][q], 10) + 2 : n[v][q]);
                                d[p] = m, d[q] = m + 1
                            } else {
    ...
    "json2xml": function (a, b) {
        var c, d = function (a, b, c) {
            ...
            if (a instanceof Array)
                ...
                e = !1, g += c + "<" + b;
                for (f in a)
                    a.hasOwnProperty(f) && ("@" === f.charAt(0) ? g += " " + f.substr(1) + '="' + a[f].toString() + '"' : e = !0);
                if (g += e ? ">" : "/>", e) {
                    for (f in a)
                        a.hasOwnProperty(f) && ("#text" === f ? g += a[f] : "#cdata" === f ? g += "<![CDATA[" + a[f] + "]]>" : "@" !== f.charAt(0) && (g += d(a[f], f, c + "	")));
                    g += ("\n" === g.charAt(g.length - 1) ? c : "") + "</" + b + ">"
                }
            } else
                "function" == typeof a ? g += c + "<" + b + "><![CDATA[" + a + "]]></" + b + ">" : (void 0 === a && (a = ""), g = '""' === a.toString() || 0 === a.toString().length ? g + (c + "<" + b + ">__EMPTY_STRING_</" + b + ">") : g + (c + "<" + b + ">" + a.toString() + "</" + b + ">"));
            return g
        },
                e = "";
        for (c in a)
            a.hasOwnProperty(c) && (e += d(a[c], c, ""));
        ...
        if (1 === a.nodeType) {
            if (a.attributes.length) {
                ...
                for (d = 0; d < a.attributes.length; d += 1)
                    b["@" + a.attributes[d].nodeName] = (a.attributes[d].nodeValue || "").toString();
            }
            if (a.firstChild) {
                var e, f = d = 0,
                        g = !1;
                for (e = a.firstChild; e; e = e.nextSibling)
                    1 === e.nodeType ? g = !0 : 3 === e.nodeType && e.nodeValue.match(/[^ \f\n\r\t\v]/) ? d += 1 : 4 === e.nodeType && (f += 1);
                if (g)
                    if (2 > d && 2 > f)
                        for (this.removeWhite(a), e = a.firstChild; e; e = e.nextSibling)
                            3 === e.nodeType ? b["#text"] = this.escape(e.nodeValue) : 4 === e.nodeType ? c.test(e.nodeValue) ? b[e.nodeName] = [b[e.nodeName], e.nodeValue] : b["#cdata"] = this.escape(e.nodeValue) : b[e.nodeName] ? b[e.nodeName] instanceof Array ? b[e.nodeName][b[e.nodeName].length] = this.toObj(e) : b[e.nodeName] = [b[e.nodeName], this.toObj(e)] : b[e.nodeName] = this.toObj(e);
                    else
                        a.attributes.length ? b["#text"] = this.escape(this.innerXml(a)) : b = this.escape(this.innerXml(a));
                else if (d)
                    a.attributes.length ? b["#text"] = this.escape(this.innerXml(a)) : (b = this.escape(this.innerXml(a)), "__EMPTY_ARRAY_" === b ? b = "[]" : "__EMPTY_STRING_" === b && (b = ""));
                else if (f)
                    if (f > 1)
    ...
    "innerXml": function (a) {
        ...
        if ("innerHTML" in a)
            ...
            for (var c = function (a) {
                var b, d = "";
                if (1 === a.nodeType) {
                    for (d += "<" + a.nodeName, b = 0; b < a.attributes.length; b += 1)
                    ...
                    3 === a.nodeType ? d += a.nodeValue : 4 === a.nodeType && (d += "<![CDATA[" + a.nodeValue + "]]>");
                return d
        ...
        "gridDnD": function (a) {
            return this.each(function () {
                ...
                if (f.grid && !f.p.treeGrid && b.fn.draggable && b.fn.droppable)
                    if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" == typeof a && "updateDnD" === a && f.p.jqgdnd === !0)
                        c();
                    else if (a = b.extend({
                        "drag": function (a) {
                            return b.extend({
                                "start": function (c, d) {
                                    ...
                                    for (e = 0; e < b.data(f, "dnd").connectWith.length; e++)
                                        0 === b(b.data(f, "dnd").connectWith[e]).jqGrid("getGridParam", "reccount") && b(b.data(f, "dnd").connectWith[e]).jqGrid("addRowData", "jqg_empty_row", {});
                                ...
                                "stop": function (c, d) {
                                    var e;
                                    for (d.helper.dropped && !a.dragcopy && (e = b(d.helper).attr("id"), void 0 === e && (e = b(this).attr("id")), b(f).jqGrid("delRowData", e)), e = 0; e < b.data(f, "dnd").connectWith.length; e++)
                                        b(b.data(f, "dnd").connectWith[e]).jqGrid("delRowData", "jqg_empty_row");
                        ...
                        for (a.connectWith = a.connectWith.split(","), a.connectWith = b.map(a.connectWith, function (a) {
                            return b.trim(a)
                        }), b.data(f, "dnd", a), 0 !== f.p.reccount && !f.p.jqgdnd && c(), f.p.jqgdnd = !0, d = 0; d < a.connectWith.length; d++)
                            e = a.connectWith[d], b(e).droppable(b.isFunction(a.drop) ? a.drop.call(b(f), a) : a.drop)
            })
        },
