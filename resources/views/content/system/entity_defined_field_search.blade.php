                                        ...
                                        <div class="widget-body">
                                            <div class="tree">
                                                <ul>
                                                    @foreach ($table->asset as $field)
                                                    <li>
                                                        <span class="label label-primary"><i class="fa fa-lg fa-minus-circle"></i> {{$field->EntityDefinedFiledListName}}</span><span class="label label-info">{{$field->EntityDefinedFieldNameInTable}}</span>
                                                        <ul>
                                                            <li>
