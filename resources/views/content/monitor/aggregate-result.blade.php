                                    ...
                                    @if(strcmp($gp_aggType, 'country') !== 0)
                                            ...
                                            @if (session()->get('locale') == 'en')
                                                <ol class="dd-list">
                                                    @foreach($country->provinces as $province)
                                                        <li class="dd-item">
                                                            <h4>
                                                                <b>{{ trans('aggregate_content.geography.province') }}</b>
                                                            </h4>
                                                        </li>
                                                        <li class="dd-item">
                                                            <div class="dd-handle">
                                                            ...
                                                            <ol class="dd-list">
                                                                @foreach($province->districts as $district)
                                                                    <li class="dd-item">
                                                                        <h4>
                                                                            <b>{{ trans('aggregate_content.geography.district') }}</b>
                                                                        </h4>
                                                                    </li>
                                                                    <li class="dd-item">
                                                                        <div class="dd-handle">
                                                                        ...
                                                                        <ol class="dd-list">
                                                                            <li class="dd-item">
                                                                                <h4>
                                                                                    <b>{{ trans('aggregate_content.geography.commune') }}</b>
                                                                                </h4>
                                                                            </li>
                                        ...
                                        @else
                                            <ol class="dd-list">
                                                @foreach($country->provinces as $province)
                                                    <li class="dd-item">
                                                        <h4><b>{{ trans('aggregate_content.geography.province') }}</b>
                                                        </h4>
                                                    </li>
                                                    <li class="dd-item">
                                                        <div class="dd-handle">
