...
<header id="header">
    ...
    <div class="pull-right">
        ...
        <?php /* <div id="hide-menu" class="btn-header pull-right">
        ...
        <?php /* <div class="btn-header transparent pull-right">
...
<aside id="left-panel">
    ...
    <nav>
        ...
        <ul>
            <!-- Navigation left  -->
            <li class="">
                <a href="inspect/inspect-chart" title="inspect-info"><i class="fa fa-lg fa-fw fa-bar-chart"></i><span class="menu-item-parent"><?php echo e(trans('inspection.inspection-graph')); ?></span></a>
            </li>
            <?php /* <li class="">
                <a href="inspect/inspect-table" title="inspect-info"><i class="fa fa-lg fa-fw fa-bar-chart"></i><span class="menu-item-parent"><?php echo e(trans('inspection.institution-inspection-table')); ?></span></a>
            </li>
            <li class="">
                <a href="inspect/inspect-children" title="inspect-info"><i class="fa fa-lg fa-fw fa-child"></i><span class="menu-item-parent"><?php echo e(trans('inspection.children-inspection-chart')); ?></span></a>
            </li> */ ?>
            ...
            <?php foreach($tables as $table): ?>
                <?php if(session()->has('locale')): ?>
                    ...
                    <?php elseif(session()->get('locale') == 'km'): ?>
                        ...
                        <li class="">
                            <a href="monitor/entity-agg/<?php echo e($table->id); ?>" title="monitor-info"><i class="fa fa-lg fa-fw fa-files-o"></i> <span class="menu-item-parent"><?php echo e(trans('home.left-menu.aggregate-list', ['orphanage' => 'មណ្ឌល'])); ?></span></a>
                        </li>
                    <?php endif; ?>
                <?php else: ?>
                    <li class="">
        ...
        <!-- Showing system config -->
            ...
            <?php /* <li class="">
                <a href="users" title="inspect-info"><i class="fa fa-lg fa-fw fa-users"></i><span class="menu-item-parent"><?php echo e(trans('user_content.user-management')); ?></span></a>
            </li>

            <li class="">
                <a href="/logout" data-action="userLogout" data-logout-msg="<?php echo e(trans('home.logout-msg')); ?>"><i class="fa fa-lg fa-fw fa-sign-out"></i><span class="menu-item-parent"><?php echo e(trans('home.top-menu.sign-out')); ?></span></a>
            </li> */ ?>
...
<script src="<?php echo e(asset('js/chart-info.js')); ?>"></script>
