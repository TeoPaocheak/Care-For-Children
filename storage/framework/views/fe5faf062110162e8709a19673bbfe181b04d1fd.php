...
<aside id="left-panel">
    ...
    <nav>
        ...
        <!-- Showing system config -->
            ...
            <li class="">
                <a href="inspect/inspect-chart" title="inspect-info"><i class="fa fa-lg fa-fw fa-university"></i><span class="menu-item-parent"><?php echo e(trans('inspection.institution-inspection-chart')); ?></span></a>
            </li>
            <li class="">
